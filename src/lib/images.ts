...
export const IMAGES = {
  ...
  heroSteppe: `${HF}/hf_20260528_063131_39c28258-a576-48cd-886a-6cb33a924957_min.webp`,

  /** Aerial view: Sarysu River Plain — green Kazakh plains from above */
  aerialGreen: `${HF}/hf_20260528_063139_5a037bf9-f9b2-40b5-b7e8-5d5dd51da8cf_min.webp`,

  /** Aral Sea Ship Graveyard — dried lakebed with rusted vessels */
  aralDry: `${HF}/hf_20260528_063134_b2c4b3a9-c1e1-48a8-ab62-a1371d15cdb3_min.webp`,

  /** Saryshaghan Saxaul Trench — saxaul forest restoration */
  saxaulRestoration: `${HF}/hf_20260528_063135_2068ddeb-5d5d-4cc7-9b95-addede6d6046_min.webp`,

  /** Aksu Field Station — tree planting and ecological restoration */
  treePlanting: `${HF}/hf_20260528_063150_5058f5db-d08b-46f1-acdd-18c0069a6498_min.webp`,

  /** Saryarqa Dala — lush Kazakh steppe grassland */
  grassland: `${HF}/hf_20260528_063137_014000ac-0a83-4eea-a1ce-c128da6a53f3_min.webp`,

  /** Korgalzhyn Wetland Reserve — water and wetland restoration */
  waterRestoration: `${HF}/hf_20260528_063144_c42e5566-4ec5-4b52-8fc3-09ea44726b68_min.webp`,

  /** Kostanay Plain — aerial view of agricultural parcels */
  farmlandAerial: `${HF}/hf_20260528_063140_430c7082-f004-4791-b1e0-e1fa33171536_min.webp`,
  ...
  satellite: `${HF}/hf_20260528_081856_5421b420-5eda-412d-9476-35e8c13ee28c_min.webp`,

  /** Saryarka Steppe — community and rural landscape */
  ruralCommunity: `${HF}/hf_20260528_063142_a216bdbe-bbbb-4fed-9725-927f813f1c2b_min.webp`,
